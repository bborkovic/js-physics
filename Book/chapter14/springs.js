...
var m = 1;
var k = 1;
var center = new Vector2D(400,150);
...
function init() {
	ball = new Ball(5,'#0000ff',m,0,true);
	ball.pos2D = new Vector2D(200,150);
	ball.draw(context);
// attractor	
...
// end points
	...
	end1.pos2D = new Vector2D(200,150);			
	end1.draw(context_bg);
	var end2 = new Ball(5,'#ff0000');
	end2.pos2D = new Vector2D(600,150);			
...
function calcForce(pos,vel){
	force = Forces.spring(k,pos.subtract(center));	
}	
