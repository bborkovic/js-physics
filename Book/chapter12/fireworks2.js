...
var vx = 150;
var vy = -100;
var numSparks = 0; // number of sparks per explosion
...
function onUp(evt){
	...
	t = 0;
	numSparks = 2*Math.floor(elapsed);
...
function explode(obj){
	createNewParticles(obj.pos2D,Math.ceil(255*Math.random()),Math.ceil(255*Math.random()),Math.ceil(255*Math.random()));
}	
