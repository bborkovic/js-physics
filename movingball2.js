...
Universe.addBoundary( Boundary.createRect("top",0));
Universe.addBoundary( Boundary.createRect("left",0) );
Universe.addBoundary( Boundary.createRect("right",Universe.width));
var b = Boundary.createRect("bottom",Universe.height);
console.log(b);
Universe.addBoundary( b );
